                        ...
                        <div class="card-body">
                            <form action="{{url('/login')}}" method="post">
                                ...
                                <div class="border-bottom ">
                                    ...
                                    <input type="email" class="border-0" placeholder="Enter email" name="email" id="email" required>
                                </div>
                                <div class="border-bottom mt-4">
                                    <label for="email"><b>Password:</b></label>
                                    <input type="password" class="border-0" placeholder="Enter Password" name="password" id="password" required>
                                </div>
                                <div class="mt-2">
