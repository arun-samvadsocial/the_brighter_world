...
<div class="page-title-box">
    <div class="row align-items-center">
        <div class="col-md-8">
            <h6 class="page-title">Edit Tip</h6>
        </div>
        <div class="col-md-4">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                    <form action="{{url('admin/edit-tips')}}" method="POST" class="outer-repeater col-lg-6 " enctype="multipart/form-data">
                                        @csrf
                                        <input type="text" name="id" value="{{$tip_data->tip_id}}" hidden />

                                        <div data-repeater-list="outer-group" class="outer">
                                            <div data-repeater-item class="outer">
                                                <div class="mb-3">
                                                    <label class="form-label" for="formname">Title :</label>
                                                    <input type="text" class="form-control" name="tip_title" id="tip_title" onchange="title_canvas()" value="{{$tip_data->tip_title}}" onkeyup="title_canvas()" placeholder="Enter Title...">
                                                    @error('tip_title')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="tip_author"  id="tip_author" onchange="tip_author_canvas()" value="{{$tip_data->author_name}}" onkeyup="tip_author_canvas()" placeholder="Enter author name" />
                                                    @error('tip_author')
                                                    <div class="text text-danger" >
                                                    {{$message}}
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    onkeyup="tip_canvas()">{{$tip_data->tip_description}}</textarea>
                                                    @error('tip')
                                                    <div class="text text-danger" >
                                                    {{$message}}
                                                    </div>
...
<script>
    ...
    input.focus();
        var tip_data = "{{$tip_data->tip_title}}";
        var tip_title = `{{$tip_data->tip_title}}`;
        var author_name = `{{$tip_data->author_name}}`;
        var tip_description = `{{$tip_data->tip_description}}`;
        if(tip_data != ""){
            drawImage(tip_title,author_name,tip_description);
            drawshareImage(tip_title,author_name,tip_description);
        }else{
            drawImage("","","");
            drawshareImage("","","");
        }
