                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All Facts</h4>
                                            ...
                                            @foreach($facts as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p>Approved</p>
                                                        <a href="{{url('admin/change-facts-status/'.$row->fact_id)}}" class="badge rounded-pill bg-danger">Reject</a>
                                                        @else
                                                        <p>Rejected</p>
                                                        <a href="{{url('admin/change-facts-status/'.$row->fact_id)}}" class="badge rounded-pill bg-success">Approve now</a>
                                                        @endif
                                                    </td>
                                                    <td>{{$row->created_at}}</td>
                                                    <td>
                                                        <a href="{{url('admin/edit-facts/'.$row->fact_id)}}" class="btn btn-primary" >Edit</a>
