...
<div class="page-title-box">
    <div class="row align-items-center">
        <div class="col-md-8">
            <h6 class="page-title">Add Quote</h6>
        </div>
        <div class="col-md-4">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                    <form action="{{url('admin/add-quotes')}}" method="POST" class="outer-repeater col-lg-6 " enctype="mulquoteart/form-data">
                                        @csrf
                                        <div data-repeater-list="outer-group" class="outer">
                                            <div data-repeater-item class="outer">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="quote_author" required  id="quote_author" onchange="quote_author_canvas()" value="" onkeyup="quote_author_canvas()" placeholder="Enter author name" />
                                                    @error('quote_author')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea rows = '5' cols = '10' name = "quote" id="quote" type="text" required placeholder = "Enter the quote" class = "form-control"
                                                    onkeyup="quote_canvas()"></textarea>
                                                    @error('quote')
                                                    <div class="text text-danger" >
                                                    {{$message}}
                                                    </div>
