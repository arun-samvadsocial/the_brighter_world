                                        ...
                                        <div data-repeater-list="outer-group" class="outer">
                                            <div data-repeater-item class="outer">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="editor1" required >{{old('editor1')}}</textarea>
                                                    <script>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label text-dark" for="formname">Global Keywords ( Don't add these Global Keywords in Keywords section.) :</label>
                                                    <label>tags,</label>
                                                    <textarea class="tags" name="keywords" rows="5"  style="width:100%" id="keywords"></textarea></p>
                                                    @error('keywords')
                                                    <div class="text text-danger" >
                                                    {{$message}}
                                                    </div>
