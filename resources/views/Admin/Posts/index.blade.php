                                            ...
                                            @endphp
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                        <a href="{{url('admin/change-post-status/'.$row->post_id)}}" class="badge rounded-pill bg-danger">Deactivated</a>
                                                        @endif
                                                        @else
                                                        @if($row->status ==1)
                                                    ...
                                                    <td>{{$row->author}}</td>
                                                    <td>
                                                        <a href="{{url('admin/edit-post/'.$row->post_id)}}" class="btn btn-primary" >Edit</a>
