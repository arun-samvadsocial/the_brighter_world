...
<div class="page-title-box">
    <div class="row align-items-center">
        <div class="col-md-8">
            <h6 class="page-title">Add New Category</h6>
        </div>
        <div class="col-md-4">
                                        ...
                                        <div data-repeater-list="outer-group" class="outer">
                                            <div data-repeater-item class="outer">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"  required value="{{old('category_name')}}" name="category_name" onInput="myFunction()" id="formname" placeholder="Enter Name...">
                                                    @error('category_name')
                                                    ...
                                                    <script>
                                                    function myFunction() {
                                                        document.getElementById("formname1").style.display = "none";
                                                    }
                                                    </script>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="0" class="form-control" required value="{{old('short_order_status')}}" placeholder="Enter short order" name="short_order_status" id="short_order_status"/>
