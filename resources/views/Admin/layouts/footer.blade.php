...
<!-- Peity chart-->
<script src="{{url('/Admin/assets/libs/peity/jquery.peity.min.js')}}"></script>

<!-- Plugin Js-->
<!-- <script src="{{url('/Admin/assets/libs/chartist/chartist.min.js')}}"></script> -->
<!-- <script src="{{url('/Admin/assets/libs/chartist-plugin-tooltips/chartist-plugin-tooltip.min.js')}}"></script> -->
...
<!-- Init js -->
<script src="{{url('/Admin/assets/js/pages/table-responsive.init.js')}}"></script>
<script src="{{url('/Admin/assets/libs/select2/js/select2.min.js')}}"></script>
<script src="{{url('/Admin/assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js')}}"></script>
<script src="{{url('/Admin/assets/libs/spectrum-colorpicker2/spectrum.min.js')}}"></script>
<script src="{{url('/Admin/assets/libs/bootstrap-maxlength/bootstrap-maxlength.min.js')}}"></script>
