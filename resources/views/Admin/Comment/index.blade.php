                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <h4 class="card-title col-lg-9">All Comments</h4>
                                <div class="search-box text-end col-lg-3">
                                    <form action="{{url('/admin/comments')}}" method="get">
                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p>Approved</p>
                                                <a href="{{url('admin/change-comment-status/'.$row->id)}}"
                                                    class="badge rounded-pill bg-danger">Unapproved</a>
                                                @else
                                                <p>Unapproved</p>
                                                <a href="{{url('admin/change-comment-status/'.$row->id)}}"
                                ...
                                <div class="table_footer row">
                                    <div class="showing col-md-5">
                                        Showing {{$comment->firstItem()}} - {{$comment->lastItem()}} of
                                        {{$comment->total()}}
                                    </div>
